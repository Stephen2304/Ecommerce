...
@endsection
  ...
  @section('content')
    @if (Cart::count() > 0)
    <div class="px-4 px-lg-0" style="position: relative; ">
                            ...
                            <tr>
                                ...
                                <td class="border-0 align-middle">
                                  <form action = "{{ route('cart.destroy', $product -> rowId ) }}" method="POST">
                                    {{ csrf_field() }}
                                    {{ method_field('DELETE') }}
                                    <center><button type="submit" class="text-white bg-danger"><i class="fa fa-trash"></i></button></td></center>
                                  </form> 
                            </tr>
                        @endforeach
                    </tbody>
            ...
            <div class="row py-5 p-4 bg-white rounded shadow-sm">
              ...
              <div class="col-lg-6">
                ...
                <div class="p-4">
                  ...
                  </ul><a href=" {{ route('checkout.index') }} " class="btn btn-dark rounded-pill py-2 px-4 btn-block">Passer a la caisse</a>
                </div>
              </div>
            </div>
